        ...
        <section className={'container'}>
          <div className={'grid grid-cols-1 place-items-start gap-10 py-48'}>
            ...
            <Typography.Custom className={'font-main text-[18.03px] leading-[32px]'}>
              ...
              to provide better service to all users. This includes first name, last name, email address, phone numbers and email groups
              that users belong to. We store this personal information on Google Cloud Services. Our legal basis for the collection of user
              data is Art 6 (1) b) GDPR and Art. 6 (1) f) GDPR. Our legitimate interest is to optimize our product, increase user
              experience, enhance our customer support, and improve our internal process efficiency.
            </Typography.Custom>
            <Typography.Custom className={'font-main text-[18.03px] font-bold leading-[32px] text-app-purple'}>
            ...
            <Typography.Custom className={'font-main text-[18.03px] leading-[32px]'}>
              ...
              specific feature and when a customer uses the product. The information is collected as data logs, images, or a logical
              sequence of images/videos to reply an issue encountered by a user. Our logging system automatically collects information such
              as the internet protocol address, browser type, browser language, referring URL, features accessed, errors generated, time
              zone, geo-location data, operating system information, and other such information that is transmitted in the header of the
              user’s HTTP request. This information is stored in log files. We use these log files to analyze trends, administer, and
              improve the application. Our legal basis for the collection of user data is Art 6 (1) b) GDPR and Art. 6 (1) f) GDPR. Our
              legitimate interest is to optimize our product, increase user experience, enhance our customer support, and improve our
            ...
            <Typography.Custom className={'font-main text-[18.03px] leading-[32px]'}>
              ...
              manage the permissions of these files through the drive APIs when the workflow on Yara attached to these files are in
              progress.
            </Typography.Custom>
          </div>
        </section>
